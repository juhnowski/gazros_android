 ...
 * @see SystemUiHider
 */
public class LogoFullscreenActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Registration form
        iReg = new Intent();
        iReg.setAction("net.phreebie.gazros.RegisterActivity");
       ...
       //Show site
        ...
        //Orders List
        iOrders  = new Intent();
        iOrders.setAction("net.phreebie.gazros.OrderListFullscreenActivity");
        final Button btnOrders = (Button) findViewById(R.id.enter_button);
